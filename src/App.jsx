...
function App() {
  ...
  const addcatrItem = async (product_id, qty) => {
    setIsLoading(true)
    try {
              ...
              <tr key={product.id}>
                ...
                <td>
                  <div className="btn-group btn-group-sm">
                    ...
                    <button disabled={isLoading} onClick={()=> addcatrItem(product.id, 1)} type="button" className="btn btn-danger d-flex align-items-center gap-2">
                      加到購物車
          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              ...
              <div className="modal-footer">
                <button disabled={isLoading} onClick={()=> addcatrItem(tempProduct.id, qtySelect)} type="button" className="btn btn-primary d-flex align-items-center gap-2">
                  <div>加入購物車</div>
                  { isLoading && ( <ReactLoading
                    type={"spin"}
                    color={"#000"}
